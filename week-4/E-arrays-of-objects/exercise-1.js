...
var personNames = persons.map(namesOfPerson); // Complete here

function isYoungerThanTwentyEight(person) {
  return person.age < 28;
}
var personsYoungerThan28YearsOld = persons.filter(isYoungerThanTwentyEight); // Complete here
