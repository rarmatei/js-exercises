...
var bottle = {
  ...
  drink: function() {
    this.volume = this.volume - 10; // calling this function should decrease your bottles volume by 10;
  },
  empty: function() {
    this.volume = 0; // this function should return true if your bottles volume = 0
  }
};
